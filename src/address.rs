...
pub fn get_bit_u8(address: u32, offset: u8) -> bool {
    let value = read_u8(address);
    value & 1 << offset != 0
}
pub fn get_bit_u16(address: u32, offset: u8) -> bool {
    let value = read_u16(address);
    value & 1 << offset != 0
}
pub fn get_bit_u32(address: u32, offset: u8) -> bool {
    let value = read_u32(address);
    value & 1 << offset != 0
}
...
pub fn clear_bit_u8(address: u32, offset: u8) {
    let mut value = read_u8(address);
    value &= !(1 << offset);
    write_u8(address, value);
}
pub fn clear_bit_u16(address: u32, offset: u8) {
    let mut value = read_u16(address);
    value &= !(1 << offset);
    write_u16(address, value);
}
pub fn clear_bit_u32(address: u32, offset: u8) {
    let mut value = read_u32(address);
    value &= !(1 << offset);
    write_u32(address, value);
}
