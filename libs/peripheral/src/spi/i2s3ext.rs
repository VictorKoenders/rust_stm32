...
pub mod cr1 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40004000u32 + 0x0u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.cpha as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40004000u32 + 0x0u32) as *mut u32, value) };
        }
    }
}
/// control register 2
pub mod cr2 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40004000u32 + 0x4u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40004000u32 + 0x4u32) as *mut u32, value) };
        }
    }
}
/// status register
pub mod sr {
    ...
    pub fn rxne() -> bool {
        let value = unsafe { ::core::ptr::read_volatile((0x40004000u32 + 0x8u32) as *mut u32) };
    ...
    pub fn set_crcerr(value: bool) {
        ...
        let value = value << 4;
        unsafe { ::core::ptr::write_volatile((0x40004000u32 + 0x8u32) as *mut u32, value) };
    }
    /// Get CRC error flag
...
pub mod dr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40004000u32 + 0xCu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.dr as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40004000u32 + 0xCu32) as *mut u32, value) };
        }
    }
}
...
pub mod crcpr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40004000u32 + 0x10u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40004000u32 + 0x10u32) as *mut u32, value) };
        }
    }
}
/// RX CRC register
pub mod rxcrcr {
    ...
    /// Get Rx CRC register
    pub fn rxcrc() -> u16 {
        let value = unsafe { ::core::ptr::read_volatile((0x40004000u32 + 0x14u32) as *mut u32) };
...
pub mod txcrcr {
    ...
    /// Get Tx CRC register
    pub fn txcrc() -> u16 {
        let value = unsafe { ::core::ptr::read_volatile((0x40004000u32 + 0x18u32) as *mut u32) };
        let value = value & (0b1111111111111111 << 0);
        value as u16
    }
}
...
pub mod i2scfgr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40004000u32 + 0x1Cu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.chlen as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40004000u32 + 0x1Cu32) as *mut u32, value) };
        }
    }
}
...
pub mod i2spr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40004000u32 + 0x20u32) as *mut u32) };
        ReadonlyCache {
            mckoe: ((value >> 9) & 0b1) > 0,
            odd: ((value >> 8) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40004000u32 + 0x20u32) as *mut u32, value) };
        }
    }
}
/*
