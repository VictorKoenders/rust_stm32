...
pub mod cr1 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40004800u32 + 0x0u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.ue as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40004800u32 + 0x0u32) as *mut u32, value) };
        }
    }
}
/// Control register 2
pub mod cr2 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40004800u32 + 0x4u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.addm7 as u32) << 4)
            ;
            unsafe { ::core::ptr::write_volatile((0x40004800u32 + 0x4u32) as *mut u32, value) };
        }
    }
}
/// Control register 3
pub mod cr3 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40004800u32 + 0x8u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.eie as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40004800u32 + 0x8u32) as *mut u32, value) };
        }
    }
}
/// Baud rate register
pub mod brr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40004800u32 + 0xCu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40004800u32 + 0xCu32) as *mut u32, value) };
        }
    }
}
...
pub mod gtpr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40004800u32 + 0x10u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.psc as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40004800u32 + 0x10u32) as *mut u32, value) };
        }
    }
}
...
pub mod rtor {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40004800u32 + 0x14u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.rto as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40004800u32 + 0x14u32) as *mut u32, value) };
        }
    }
}
/// Request register
pub mod rqr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40004800u32 + 0x18u32) as *mut u32) };
        ReadonlyCache {
            txfrq: ((value >> 4) & 0b1) > 0,
            rxfrq: ((value >> 3) & 0b1) > 0,
            mmrq: ((value >> 2) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.abrrq as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40004800u32 + 0x18u32) as *mut u32, value) };
        }
    }
}
...
pub mod isr {
    ...
    pub fn reack() -> bool {
        let value = unsafe { ::core::ptr::read_volatile((0x40004800u32 + 0x1Cu32) as *mut u32) };
...
pub mod icr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40004800u32 + 0x20u32) as *mut u32) };
        ReadonlyCache {
            wucf: ((value >> 20) & 0b1) > 0,
            cmcf: ((value >> 17) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.pecf as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40004800u32 + 0x20u32) as *mut u32, value) };
        }
    }
}
...
pub mod rdr {
    ...
    pub fn rdr() -> u16 {
        let value = unsafe { ::core::ptr::read_volatile((0x40004800u32 + 0x24u32) as *mut u32) };
...
pub mod tdr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40004800u32 + 0x28u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.tdr as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40004800u32 + 0x28u32) as *mut u32, value) };
        }
    }
}
