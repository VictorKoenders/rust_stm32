...
pub mod cr1 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x0u32) as *mut u32) };
        ReadonlyCache {
            cen: ((value >> 0) & 0b1) > 0,
            udis: ((value >> 1) & 0b1) > 0,
            urs: ((value >> 2) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x0u32) as *mut u32, value) };
        }
    }
}
/// control register 2
pub mod cr2 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x4u32) as *mut u32) };
        ReadonlyCache {
            ccpc: ((value >> 0) & 0b1) > 0,
            ccus: ((value >> 2) & 0b1) > 0,
            ccds: ((value >> 3) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.mms2 as u32) << 20)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x4u32) as *mut u32, value) };
        }
    }
}
...
pub mod smcr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x8u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.sms3 as u32) << 16)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x8u32) as *mut u32, value) };
        }
    }
}
...
pub mod dier {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0xCu32) as *mut u32) };
        ReadonlyCache {
            tde: ((value >> 14) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.uie as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0xCu32) as *mut u32, value) };
        }
    }
}
/// status register
pub mod sr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x10u32) as *mut u32) };
        ReadonlyCache {
            uif: ((value >> 0) & 0b1) > 0,
            cc1if: ((value >> 1) & 0b1) > 0,
            cc2if: ((value >> 2) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.c6if as u32) << 17)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x10u32) as *mut u32, value) };
        }
    }
}
...
pub mod egr {
    ...
    pub fn ug(value: bool) {
        ...
        unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x14u32) as *mut u32, value) };
    }
...
pub mod ccmr1_output {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x18u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x18u32) as *mut u32, value) };
        }
    }
}
...
pub mod ccmr2_output {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x1Cu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x1Cu32) as *mut u32, value) };
        }
    }
}
...
pub mod ccer {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x20u32) as *mut u32) };
        ReadonlyCache {
            cc1e: ((value >> 0) & 0b1) > 0,
            cc1p: ((value >> 1) & 0b1) > 0,
            cc1ne: ((value >> 2) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.cc6p as u32) << 21)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x20u32) as *mut u32, value) };
        }
    }
}
/// counter
pub mod cnt {
    ...
    pub fn set_cnt(value: u16) {
        let value = value as u32;
        unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x24u32) as *mut u32, value) };
    }
    /// Get counter value
    pub fn get_cnt() -> u16 {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x24u32) as *mut u32) };
...
pub mod psc {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x28u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.psc as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x28u32) as *mut u32, value) };
        }
    }
}
...
pub mod arr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x2Cu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.arr as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x2Cu32) as *mut u32, value) };
        }
    }
}
...
pub mod rcr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x30u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.rep as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x30u32) as *mut u32, value) };
        }
    }
}
...
pub mod ccr1 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x34u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.ccr1 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x34u32) as *mut u32, value) };
        }
    }
}
...
pub mod ccr2 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x38u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.ccr2 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x38u32) as *mut u32, value) };
        }
    }
}
...
pub mod ccr3 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x3Cu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.ccr3 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x3Cu32) as *mut u32, value) };
        }
    }
}
...
pub mod ccr4 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x40u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.ccr4 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x40u32) as *mut u32, value) };
        }
    }
}
...
pub mod bdtr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x44u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.bk2p as u32) << 25)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x44u32) as *mut u32, value) };
        }
    }
}
...
pub mod dcr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x48u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.dba as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x48u32) as *mut u32, value) };
        }
    }
}
...
pub mod dmar {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x4Cu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.dmab as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x4Cu32) as *mut u32, value) };
        }
    }
}
...
pub mod ccmr3_output {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x54u32) as *mut u32) };
        ReadonlyCache {
            oc5fe: ((value >> 2) & 0b1) > 0,
            oc5pe: ((value >> 3) & 0b1) > 0,
            oc5m: ((value >> 4) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x54u32) as *mut u32, value) };
        }
    }
}
...
pub mod ccr5 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x58u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x58u32) as *mut u32, value) };
        }
    }
}
...
pub mod ccr6 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x5Cu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.ccr6 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x5Cu32) as *mut u32, value) };
        }
    }
}
/// option registers
pub mod or {
    pub struct ReadonlyCache {
        ...
        pub tim8_etr_adc2_rmp: u8,
        /// TIM8_ETR_ADC3 remapping capability
        pub tim8_etr_adc3_rmp: u8,
    }
    pub struct Cache {
        /// TIM8_ETR_ADC2 remapping capability
        pub tim8_etr_adc2_rmp: u8,
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x60u32) as *mut u32) };
        ReadonlyCache {
            tim8_etr_adc2_rmp: ((value >> 0) & 0b11) as u8,
            tim8_etr_adc3_rmp: ((value >> 2) & 0b11) as u8,
        }
    }
    pub fn modify() -> Cache {
        let value = unsafe { ::core::ptr::read_volatile((0x40013400u32 + 0x60u32) as *mut u32) };
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.tim8_etr_adc2_rmp as u32) << 0)
                | ((self.tim8_etr_adc3_rmp as u32) << 2)
            ;
            unsafe { ::core::ptr::write_volatile((0x40013400u32 + 0x60u32) as *mut u32, value) };
        }
    }
}
