...
pub mod cr1 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40014800u32 + 0x0u32) as *mut u32) };
        ReadonlyCache {
            cen: ((value >> 0) & 0b1) > 0,
            udis: ((value >> 1) & 0b1) > 0,
            urs: ((value >> 2) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40014800u32 + 0x0u32) as *mut u32, value) };
        }
    }
}
/// control register 2
pub mod cr2 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40014800u32 + 0x4u32) as *mut u32) };
        ReadonlyCache {
            ois1n: ((value >> 9) & 0b1) > 0,
            ois1: ((value >> 8) & 0b1) > 0,
            ccds: ((value >> 3) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.ccpc as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40014800u32 + 0x4u32) as *mut u32, value) };
        }
    }
}
...
pub mod dier {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40014800u32 + 0xCu32) as *mut u32) };
        ReadonlyCache {
            uie: ((value >> 0) & 0b1) > 0,
            cc1ie: ((value >> 1) & 0b1) > 0,
            comie: ((value >> 5) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.tde as u32) << 14)
            ;
            unsafe { ::core::ptr::write_volatile((0x40014800u32 + 0xCu32) as *mut u32, value) };
        }
    }
}
/// status register
pub mod sr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40014800u32 + 0x10u32) as *mut u32) };
        ReadonlyCache {
            cc1of: ((value >> 9) & 0b1) > 0,
            bif: ((value >> 7) & 0b1) > 0,
            tif: ((value >> 6) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.uif as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40014800u32 + 0x10u32) as *mut u32, value) };
        }
    }
}
...
pub mod egr {
    ...
    pub fn bg(value: bool) {
        ...
        let value = value << 7;
        unsafe { ::core::ptr::write_volatile((0x40014800u32 + 0x14u32) as *mut u32, value) };
    }
    /// Trigger generation
...
pub mod ccmr1_output {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40014800u32 + 0x18u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40014800u32 + 0x18u32) as *mut u32, value) };
        }
    }
}
...
pub mod ccer {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40014800u32 + 0x20u32) as *mut u32) };
        ReadonlyCache {
            cc1np: ((value >> 3) & 0b1) > 0,
            cc1ne: ((value >> 2) & 0b1) > 0,
            cc1p: ((value >> 1) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.cc1e as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40014800u32 + 0x20u32) as *mut u32, value) };
        }
    }
}
/// counter
pub mod cnt {
    ...
    pub fn set_cnt(value: u16) {
        let value = value as u32;
        unsafe { ::core::ptr::write_volatile((0x40014800u32 + 0x24u32) as *mut u32, value) };
    }
    /// Get counter value
    pub fn get_cnt() -> u16 {
        let value = unsafe { ::core::ptr::read_volatile((0x40014800u32 + 0x24u32) as *mut u32) };
...
pub mod psc {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40014800u32 + 0x28u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.psc as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40014800u32 + 0x28u32) as *mut u32, value) };
        }
    }
}
...
pub mod arr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40014800u32 + 0x2Cu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.arr as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40014800u32 + 0x2Cu32) as *mut u32, value) };
        }
    }
}
...
pub mod rcr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40014800u32 + 0x30u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.rep as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40014800u32 + 0x30u32) as *mut u32, value) };
        }
    }
}
...
pub mod ccr1 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40014800u32 + 0x34u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.ccr1 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40014800u32 + 0x34u32) as *mut u32, value) };
        }
    }
}
...
pub mod bdtr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40014800u32 + 0x44u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.bkf as u32) << 16)
            ;
            unsafe { ::core::ptr::write_volatile((0x40014800u32 + 0x44u32) as *mut u32, value) };
        }
    }
}
...
pub mod dcr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40014800u32 + 0x48u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.dba as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40014800u32 + 0x48u32) as *mut u32, value) };
        }
    }
}
...
pub mod dmar {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40014800u32 + 0x4Cu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.dmab as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40014800u32 + 0x4Cu32) as *mut u32, value) };
        }
    }
}
/// TIM1 trigger and commutation/TIM17 interrupts
pub const INTERRUPT_TIM1_TRG_COM_TIM17: u32 = 26;
/*
<?xml version="1.0"?>
