...
pub mod cr1 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x0u32) as *mut u32) };
        ReadonlyCache {
            cen: ((value >> 0) & 0b1) > 0,
            udis: ((value >> 1) & 0b1) > 0,
            urs: ((value >> 2) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x0u32) as *mut u32, value) };
        }
    }
}
/// control register 2
pub mod cr2 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x4u32) as *mut u32) };
        ReadonlyCache {
            ti1s: ((value >> 7) & 0b1) > 0,
            mms: ((value >> 4) & 0b1) > 0,
            ccds: ((value >> 3) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.ccds as u32) << 3)
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x4u32) as *mut u32, value) };
        }
    }
}
...
pub mod smcr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x8u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x8u32) as *mut u32, value) };
        }
    }
}
...
pub mod dier {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0xCu32) as *mut u32) };
        ReadonlyCache {
            tde: ((value >> 14) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.uie as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0xCu32) as *mut u32, value) };
        }
    }
}
/// status register
pub mod sr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x10u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.uif as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x10u32) as *mut u32, value) };
        }
    }
}
...
pub mod egr {
    ...
    pub fn tg(value: bool) {
        ...
        let value = value << 6;
        unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x14u32) as *mut u32, value) };
    }
...
pub mod ccmr1_output {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x18u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x18u32) as *mut u32, value) };
        }
    }
}
...
pub mod ccmr2_output {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x1Cu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x1Cu32) as *mut u32, value) };
        }
    }
}
...
pub mod ccer {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x20u32) as *mut u32) };
        ReadonlyCache {
            cc1e: ((value >> 0) & 0b1) > 0,
            cc1p: ((value >> 1) & 0b1) > 0,
            cc1np: ((value >> 3) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x20u32) as *mut u32, value) };
        }
    }
}
/// counter
pub mod cnt {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x24u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x24u32) as *mut u32, value) };
        }
    }
}
/// prescaler
pub mod psc {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x28u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.psc as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x28u32) as *mut u32, value) };
        }
    }
}
...
pub mod arr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x2Cu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.arrh as u32) << 16)
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x2Cu32) as *mut u32, value) };
        }
    }
}
...
pub mod ccr1 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x34u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x34u32) as *mut u32, value) };
        }
    }
}
...
pub mod ccr2 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x38u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x38u32) as *mut u32, value) };
        }
    }
}
...
pub mod ccr3 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x3Cu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x3Cu32) as *mut u32, value) };
        }
    }
}
...
pub mod ccr4 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x40u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x40u32) as *mut u32, value) };
        }
    }
}
...
pub mod dcr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x48u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.dba as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x48u32) as *mut u32, value) };
        }
    }
}
...
pub mod dmar {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40000800u32 + 0x4Cu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                | ((self.dmab as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40000800u32 + 0x4Cu32) as *mut u32, value) };
        }
    }
}
