...
pub mod isr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x0u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.adrdy as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x0u32) as *mut u32, value) };
        }
    }
}
...
pub mod ier {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x4u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x4u32) as *mut u32, value) };
        }
    }
}
/// control register
pub mod cr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x8u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.aden as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x8u32) as *mut u32, value) };
        }
    }
}
...
pub mod cfgr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0xCu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.dmaen as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0xCu32) as *mut u32, value) };
        }
    }
}
...
pub mod smpr1 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x14u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.smp1 as u32) << 3)
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x14u32) as *mut u32, value) };
        }
    }
}
...
pub mod smpr2 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x18u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.smp10 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x18u32) as *mut u32, value) };
        }
    }
}
...
pub mod tr1 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x20u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.lt1 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x20u32) as *mut u32, value) };
        }
    }
}
...
pub mod tr2 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x24u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.lt2 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x24u32) as *mut u32, value) };
        }
    }
}
...
pub mod tr3 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x28u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.lt3 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x28u32) as *mut u32, value) };
        }
    }
}
...
pub mod sqr1 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x30u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.l3 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x30u32) as *mut u32, value) };
        }
    }
}
...
pub mod sqr2 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x34u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.sq5 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x34u32) as *mut u32, value) };
        }
    }
}
...
pub mod sqr3 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x38u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.sq10 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x38u32) as *mut u32, value) };
        }
    }
}
...
pub mod sqr4 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x3Cu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.sq15 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x3Cu32) as *mut u32, value) };
        }
    }
}
...
pub mod dr {
    ...
    pub fn regulardata() -> u16 {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x40u32) as *mut u32) };
...
pub mod jsqr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x4Cu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.jl as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x4Cu32) as *mut u32, value) };
        }
    }
}
/// offset register 1
pub mod ofr1 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x60u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x60u32) as *mut u32, value) };
        }
    }
}
/// offset register 2
pub mod ofr2 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x64u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x64u32) as *mut u32, value) };
        }
    }
}
/// offset register 3
pub mod ofr3 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x68u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x68u32) as *mut u32, value) };
        }
    }
}
/// offset register 4
pub mod ofr4 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x6Cu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0x6Cu32) as *mut u32, value) };
        }
    }
}
...
pub mod jdr1 {
    ...
    /// Get JDATA1
    pub fn jdata1() -> u16 {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x80u32) as *mut u32) };
        let value = value & (0b1111111111111111 << 0);
        value as u16
    }
}
...
pub mod jdr2 {
    ...
    /// Get JDATA2
    pub fn jdata2() -> u16 {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x84u32) as *mut u32) };
        let value = value & (0b1111111111111111 << 0);
        value as u16
    }
}
...
pub mod jdr3 {
    ...
    /// Get JDATA3
    pub fn jdata3() -> u16 {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x88u32) as *mut u32) };
        let value = value & (0b1111111111111111 << 0);
        value as u16
    }
}
...
pub mod jdr4 {
    ...
    /// Get JDATA4
    pub fn jdata4() -> u16 {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0x8Cu32) as *mut u32) };
        let value = value & (0b1111111111111111 << 0);
        value as u16
    }
}
...
pub mod awd2cr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0xA0u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0xA0u32) as *mut u32, value) };
        }
    }
}
...
pub mod awd3cr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0xA4u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0xA4u32) as *mut u32, value) };
        }
    }
}
...
pub mod difsel {
    ...
    pub fn set_difsel__(index: u8, value: u16) {
        ...
        unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0xB0u32) as *mut u32, value) };
    }
    /// Get Differential mode for channels 15 to 1
    pub fn get_difsel__(index: u8) -> u16 {
        debug_assert!(index < 2, "get_difsel__ out of range");
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0xB0u32) as *mut u32) };
...
pub mod calfact {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000500u32 + 0xB4u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x50000500u32 + 0xB4u32) as *mut u32, value) };
        }
    }
}
/// ADC4 global interrupt
pub const INTERRUPT_ADC4: u32 = 61;
/*
<?xml version="1.0"?>
