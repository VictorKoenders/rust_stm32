...
pub mod csr {
    ...
    pub fn addrdy_mst() -> bool {
        let value = unsafe { ::core::ptr::read_volatile((0x50000700u32 + 0x0u32) as *mut u32) };
...
pub mod ccr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x50000700u32 + 0x8u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x50000700u32 + 0x8u32) as *mut u32, value) };
        }
    }
}
...
pub mod cdr {
    ...
    pub fn rdata_slv() -> u16 {
        let value = unsafe { ::core::ptr::read_volatile((0x50000700u32 + 0xCu32) as *mut u32) };
...
/*
<?xml version="1.0"?>
<peripheral xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" derivedFrom="ADC1_2">
  <addressBlock>
    <offset>0x0</offset>
    <size>0xD</size>
