...
pub mod cr1 {
    ...
    pub fn set_pe(value: bool) {
        ...
        unsafe { ::core::ptr::write_volatile((0x40005800u32 + 0x0u32) as *mut u32, value) };
    }
    /// Get Peripheral enable
    pub fn get_pe() -> bool {
        let value = unsafe { ::core::ptr::read_volatile((0x40005800u32 + 0x0u32) as *mut u32) };
...
pub mod cr2 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40005800u32 + 0x4u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.sadd0 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x40005800u32 + 0x4u32) as *mut u32, value) };
        }
    }
}
...
pub mod oar1 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40005800u32 + 0x8u32) as *mut u32) };
        ReadonlyCache {
            oa1_0: ((value >> 0) & 0b1) > 0,
            oa1_1: ((value >> 1) & 0b1) > 0,
            oa1_8: ((value >> 8) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40005800u32 + 0x8u32) as *mut u32, value) };
        }
    }
}
...
pub mod oar2 {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40005800u32 + 0xCu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40005800u32 + 0xCu32) as *mut u32, value) };
        }
    }
}
/// Timing register
pub mod timingr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40005800u32 + 0x10u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40005800u32 + 0x10u32) as *mut u32, value) };
        }
    }
}
/// Status register 1
pub mod timeoutr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40005800u32 + 0x14u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40005800u32 + 0x14u32) as *mut u32, value) };
        }
    }
}
...
pub mod isr {
    ...
    pub fn addcode() -> u8 {
        let value = unsafe { ::core::ptr::read_volatile((0x40005800u32 + 0x18u32) as *mut u32) };
    ...
    pub fn set_txis(value: bool) {
        let value = value as u32;
        let value = value << 1;
        unsafe { ::core::ptr::write_volatile((0x40005800u32 + 0x18u32) as *mut u32, value) };
    }
...
pub mod icr {
    ...
    pub fn alertcf(value: bool) {
        let value = value as u32;
        let value = value << 13;
        unsafe { ::core::ptr::write_volatile((0x40005800u32 + 0x1Cu32) as *mut u32, value) };
    }
...
pub mod pecr {
    ...
    pub fn pec() -> u8 {
        let value = unsafe { ::core::ptr::read_volatile((0x40005800u32 + 0x20u32) as *mut u32) };
...
pub mod rxdr {
    ...
    pub fn rxdata() -> u8 {
        let value = unsafe { ::core::ptr::read_volatile((0x40005800u32 + 0x24u32) as *mut u32) };
        let value = value & (0b11111111 << 0);
        value as u8
    }
}
...
pub mod txdr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x40005800u32 + 0x28u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x40005800u32 + 0x28u32) as *mut u32, value) };
        }
    }
}
/// I2C2 event interrupt & EXTI Line24 interrupt
pub const INTERRUPT_I2C2_EV_EXTI24: u32 = 33;
/// I2C2 error interrupt
pub const INTERRUPT_I2C2_ER: u32 = 34;
/*
<?xml version="1.0"?>
<peripheral xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" derivedFrom="I2C1">
  <addressBlock>
    <offset>0x0</offset>
    <size>0x400</size>
