...
pub mod moder {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x48000800u32 + 0x0u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x48000800u32 + 0x0u32) as *mut u32, value) };
        }
    }
}
...
pub mod otyper {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x48000800u32 + 0x4u32) as *mut u32) };
        ReadonlyCache {
            ot15: ((value >> 15) & 0b1) > 0,
            ot14: ((value >> 14) & 0b1) > 0,
            ot13: ((value >> 13) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.ot0 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x48000800u32 + 0x4u32) as *mut u32, value) };
        }
    }
}
...
pub mod ospeedr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x48000800u32 + 0x8u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x48000800u32 + 0x8u32) as *mut u32, value) };
        }
    }
}
...
pub mod pupdr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x48000800u32 + 0xCu32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            ...
            ;
            unsafe { ::core::ptr::write_volatile((0x48000800u32 + 0xCu32) as *mut u32, value) };
        }
    }
}
...
pub mod idr {
    ...
    pub fn idr(index: u8) -> bool {
        ...
        let value = unsafe { ::core::ptr::read_volatile((0x48000800u32 + 0x10u32) as *mut u32) };
...
pub mod odr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x48000800u32 + 0x14u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.odr0 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x48000800u32 + 0x14u32) as *mut u32, value) };
        }
    }
}
...
pub mod bsrr {
    ...
    pub fn br(index: u8, value: bool) {
        ...
        unsafe { ::core::ptr::write_volatile((0x48000800u32 + 0x18u32) as *mut u32, value) };
    }
...
pub mod lckr {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x48000800u32 + 0x1Cu32) as *mut u32) };
        ReadonlyCache {
            lckk: ((value >> 16) & 0b1) > 0,
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.lck0 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x48000800u32 + 0x1Cu32) as *mut u32, value) };
        }
    }
}
...
pub mod afrl {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x48000800u32 + 0x20u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.afrl0 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x48000800u32 + 0x20u32) as *mut u32, value) };
        }
    }
}
...
pub mod afrh {
    ...
    pub fn load() -> ReadonlyCache {
        let value = unsafe { ::core::ptr::read_volatile((0x48000800u32 + 0x24u32) as *mut u32) };
        ReadonlyCache {
    ...
    impl ::core::ops::Drop for Cache {
        fn drop(&mut self) {
            let value = 0
                ...
                | ((self.afrh8 as u32) << 0)
            ;
            unsafe { ::core::ptr::write_volatile((0x48000800u32 + 0x24u32) as *mut u32, value) };
        }
    }
}
...
pub mod brr {
    ...
    pub fn br(index: u8, value: bool) {
        ...
        let value = value as u32;
        let value = value << (0 + index * 1);
        unsafe { ::core::ptr::write_volatile((0x48000800u32 + 0x28u32) as *mut u32, value) };
    }
}
/*
<?xml version="1.0"?>
